...
We've all been contacted by sales before we're actually ready to purchase a solution, where you think "I'm not ready to purchase yet, so why am I being contacted every other day?" The reason for this is sometimes due to a lead scoring model that classifies a lead as `hot` and **ready to talk to**, but in reality, you as the lead know you are not yet ready to talk to sales (you may have just wanted to download interesting content or try out the product). This application aims to enrich leads with better information about leads' purchase intent, so that sales doesn't waste its time on low-intent leads.
